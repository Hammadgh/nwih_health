          ...
          <div className="mobile-menu xl:hidden bg-white/98 backdrop-blur-sm border-t border-gray-100 shadow-lg">
            <div className="container mx-auto px-4 py-4">
              <div className="flex flex-col space-y-1 text-[#0077C8]">
                ...
                <Link href="/" className="nav-link py-3 border-b border-gray-50 text-[#0077C8] text-base" onClick={() => setIsMenuOpen(false)}>
                  Home
                </Link>
                ...
                <div className="pt-6">
                  <a 
                    href="tel:1-877-522-1275" 
                    className="cta-button block bg-gradient-to-r from-[#16A53F] to-[#128a35] hover:from-[#128a35] hover:to-[#0f7a2e] text-white text-center font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full transition-all duration-300 text-base shadow-lg"
