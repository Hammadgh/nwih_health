    ...
    <div className={`bg-white rounded-md shadow-lg p-6 ${className}`}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-[#0077C8] hover:bg-[#005fa0] text-white font-medium rounded-md shadow-md transition-colors duration-200"
        >
      ...
      <div className="mt-4">
        <Link 
          href="/find-clinic" 
          className="block w-full text-center py-3 px-4 border border-[#0077C8] text-[#0077C8] font-medium rounded-md hover:bg-gray-50 transition-colors duration-200"
        >
          Find a Clinic
        </Link>
      </div>
