          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Immediate Access</h3>
                <p className="text-gray-600">
                  Same-day appointments and walk-in availability when possible
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <p className="text-gray-600">
                  Proven MAT protocols with comprehensive support services
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Integrated Care</h3>
                <p className="text-gray-600">
                  Medical, counseling, and support services all in one place
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <p className="text-gray-600">
                  Understanding staff who have walked the recovery path
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Convenient Locations</h3>
                <p className="text-gray-600">
                  Four clinics across Washington with in-house pharmacy
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/50 text-center">
                ...
                <p className="text-gray-600">
                  Thousands of patients have achieved lasting recovery
                </p>
              </div>
            </div>
          </div>
