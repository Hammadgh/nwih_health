              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <h3 className="text-sm font-semibold text-[#0077C8] mb-2">Referral Line</h3>
                    <p className="text-gray-700 text-sm">Staffed Monday–Friday 4:30 AM–4:00 PM</p>
                    <p className="text-gray-700 text-sm">Saturday 6:30 AM–11:00 AM</p>
                    <p className="text-gray-600 text-xs mt-2">Rings in all Intake offices and at the 38th Street front desk.</p>
                  </div>
