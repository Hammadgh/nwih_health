...
import { FaUsers, FaHandsHelping, FaHeart, FaMapMarkerAlt, FaPhone, FaShieldAlt, FaInfoCircle, FaCheckCircle, FaUserFriends, FaComments } from 'react-icons/fa';

export default function PeerCounselingPage() {
  const resources = [
    { 
      name: 'NA Meetings in Pierce County', 
      description: 'Find Narcotics Anonymous meetings near you',
      link: 'https://www.na.org/meetingsearch/', 
      external: true 
    },
    { 
      name: 'AA Meetings in Pierce County', 
      description: 'Find Alcoholics Anonymous meetings near you',
  ...
  const benefits = [
    {
      ...
      description: "Connect with peers who understand your journey and challenges firsthand"
    },
    {
      icon: FaHandsHelping,
      title: "Trained Specialists",
      description: "Our peer counselors are trained specialists with personal recovery experience"
    },
    {
      icon: FaHeart,
      title: "Empathetic Support",
      description: "Receive compassionate support from those who truly understand your struggles"
    },
    {
      icon: FaComments,
      title: "Group Support",
      description: "Join supportive group sessions with others on similar recovery paths"
    }
  ];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-6 sm:mb-8 leading-relaxed px-2">
                No matter what addiction you are recovering from, having a circle of peers with similar experiences is essential.
              </p>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 max-w-3xl mx-auto">
                <p className="text-white text-base sm:text-lg leading-relaxed">
                  Our trained peer specialists have gone through their own experiences of recovery from mental illness or addiction, delivering empathetic support for long-term recovery.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
                Understanding Peer <span className="text-[#0077C8]">Counseling</span>
              </h2>
              <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto px-2">
                People recovering from addiction to opioids, stimulants, and alcohol often find NA (Narcotics Anonymous) or AA (Alcoholics Anonymous) helpful. The burden of withdrawals and the uncertainties of adapting to a new life are lighter when shared with people with similar struggles.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-12">
              <div className="bg-gradient-to-br from-[#0077C8] to-[#16A53F] rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-1 sm:mb-2 leading-tight">Peer Support Groups</h3>
                    <p className="text-white/80 font-medium text-sm sm:text-base">NA and AA meetings</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Trained Peer Specialists</h3>
                    <p className="text-gray-600 text-sm sm:text-base">Personal experience + professional training</p>
                  </div>
                </div>
                <p className="text-gray-700 text-sm sm:text-base mb-3">
                  Our peer counselors are trained peer specialists who have gone through their own experiences of recovery from mental illness or addiction. This combination of skill and personal experience delivers empathetic support for long-term recovery.
                </p>
                <div className="bg-blue-50 border border-blue-200 text-blue-900 rounded-lg p-4 text-sm">
                  <strong>Call Us Today!</strong> 253-503-0226
                </div>
              </div>
            </div>
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-2">
                Access trusted recovery resources and support services to strengthen your peer counseling journey.
              </p>
            </div>
                ...
                <div key={idx} className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
                  <div className="flex items-center mb-4 sm:mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm sm:text-base">{r.description || 'Verified resource'}</p>
                    </div>
                  </div>
                  {r.external ? (
                    <a
